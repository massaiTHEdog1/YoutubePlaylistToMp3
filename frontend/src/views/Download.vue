<template>
	<b-form @submit="onSubmit">
		...
		<b-button type="submit" variant="primary" v-if="!isLoading">Download</b-button>
    </b-form>
</template>
<script lang="ts">
